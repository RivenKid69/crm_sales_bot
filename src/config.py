...
Задача: Начать выяснять потребности клиента.
...
Ответ на русском: спроси сколько человек в команде или какую задачу хотят решить (2-3 предложения, без приветствия):""",
